package study.blog.comment.domain.entity;

import jakarta.persistence.*;
import lombok.Getter;
import lombok.NoArgsConstructor;
import study.blog.comment.domain.CommentStatus;
import study.blog.comment.domain.exception.InValidCommentContentException;
import study.blog.comment.domain.exception.TooManyContentLengthException;
