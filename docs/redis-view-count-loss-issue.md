...
>
> 👉 [문서 보기](https://redis.io/docs/latest/commands/getdel/) 

> **ValueOperations (Spring Data Redis)**
>
> Returns the string value of a key after deleting the key.
>
> 👉 [문서 보기](https://docs.spring.io/spring-data/redis/docs/current/api/org/springframework/data/redis/core/ValueOperations.html)
